...
public class OrderHistory 
{
	...
	public OrderHistory(long hId, List<String> seat, List<Double> price, double total, String movieName,Date bookOnDate, Date showOnDate, String showTime, Customer customer)
	{
		super();
		this.hId = hId;
		this.seat = seat;
	...
	public OrderHistory(List<String> seat, List<Double> price, double total, String movieName, Date bookOnDate,Date showOnDate, String showTime, Customer customer) 
	{
		super();
		this.seat = seat;
		this.price = price;
