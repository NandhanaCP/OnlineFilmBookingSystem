...
public class Seat 
{
	...
	public Seat(List<String> seatNo, List<Double> price, double total, Customer customer,CurrentDateOperation operation) 
	{
		super();
		this.seatNo = seatNo;
		this.price = price;
	...
	public Seat(long sId, List<String> seatNo, List<Double> price, double total, Customer customer,CurrentDateOperation operation) 
	{
		super();
		this.sId = sId;
		this.seatNo = seatNo;
